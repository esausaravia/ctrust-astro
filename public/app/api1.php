...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    @$data = [
        'nombre' => filter_input(INPUT_POST, 'nombre1', FILTER_SANITIZE_STRING),
        'telefono' => filter_input(INPUT_POST, 'telefono1', FILTER_SANITIZE_STRING),
        'email' => filter_input(INPUT_POST, 'email1', FILTER_SANITIZE_EMAIL),
        'edad' => filter_input(INPUT_POST, 'edad1', FILTER_SANITIZE_NUMBER_INT),
        'utm_source' => filter_input(INPUT_POST, 'utm_source1', FILTER_SANITIZE_STRING),
        'utm_medium' => filter_input(INPUT_POST, 'utm_medium1', FILTER_SANITIZE_STRING),
        'utm_campaign' => filter_input(INPUT_POST, 'utm_campaign1', FILTER_SANITIZE_STRING),
        'utm_term' => filter_input(INPUT_POST, 'utm_term1', FILTER_SANITIZE_STRING),
        'utm_content' => filter_input(INPUT_POST, 'utm_content1', FILTER_SANITIZE_STRING)
    ];
